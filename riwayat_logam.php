...
$sql = "SELECT * FROM form_penjualan where jenis = 'logam'";
            ...
            <table class="table table-striped table-bordered">
                ...
                <tfoot>
                    <tr>
                        ...
                        <th></th>
                        <th></th>
                        <th><?php echo $totalBerat > 0 ? $totalBerat : 0; ?></th>
                        <th></th>
                        <th></th>
                        <th><?php echo $totalHarga > 0 ? $totalHarga : 0; ?></th>
                        <th></th>
                    </tr>
                </tfoot>
            </table>
